		...
		<div class="panel-body">
			<table class="table table-bordered table-striped">
				<tr>
					...
					<?php
          				$data = mysqli_query($koneksi,"SELECT * FROM pinjam JOIN user ON pinjam.user_id = user.user_id JOIN kendaraan ON pinjam.kendaraan_nomor = kendaraan.kendaraan_nomor order by pinjam_id desc limit 10");
          				$no = 1;
